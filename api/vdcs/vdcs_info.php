...
A AS (
	...
	, NVL(NVL(MS.FROM_COMP_NAME, DC.TR_FROM_COMP_NAME), DC.FROM_COMP_NAME) FROM_COMP_NAME, MS.FROM_COMP_NAME ENV_FROM_COMP_NAME, DC.TR_FROM_COMP_NAME, DC.FROM_COMP_NAME LATEST_FROM_COMP_NAME
	--, DC.TR_RFQ_TITLE
